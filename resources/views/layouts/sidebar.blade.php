 <div class="p-6 ">
   ...
   <ul class="space-y-6 text-md px-4 py-2 text-text-light">
    ...
    <li>
        <a href="{{ route('batch-inventory') }}"
           class="flex items-center gap-3 hover:text-orange-300 transition {{ request()->routeIs('batch-inventory') ? 'text-orange-500 font-semibold' : '' }}">
            <!-- Box Inventory SVG -->
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M3 7l9-4 9 4M4 10v10a1 1 0 001 1h14a1 1 0 001-1V10M4 10l8 5 8-5" />
            </svg>
            Batch Inventory
        </a>
    </li>
