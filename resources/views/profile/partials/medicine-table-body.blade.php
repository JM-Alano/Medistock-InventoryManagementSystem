...
<tr class="hover:bg-secondary-light transition duration-150 ease-in-out">
    ...
    <td class="px-4 py-3">
        <div class="flex items-center gap-3" x-data="{ showEditModal: false }">
            ...
            <button  data-id="{{ $medicine->id }}" class="delete-btn bg-red-200 p-1 rounded-sm hover:bg-red-300 transition duration-150 ease-in-out">
                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="medicine_name" value="{{ $medicine->medicine_name }}"
                                class="w-full border px-3 py-2 rounded mt-1 focus:outline-none focus:ring-2 focus:ring-accent">
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700">Brand</label>
                            <input type="text" name="brand_name" value="{{ $medicine->brand_name }}"
                                class="w-full border px-3 py-2 rounded mt-1 focus:outline-none focus:ring-2 focus:ring-accent">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category" class="w-full border px-3 py-2 rounded mt-1 focus:outline-none focus:ring-2 focus:ring-accent">
